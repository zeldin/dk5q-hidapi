...
extern int dk5q_set_key_r(dk5q_handle handle, uint8_t key, uint8_t r, bool delayed);
extern int dk5q_set_key_g(dk5q_handle handle, uint8_t key, uint8_t g, bool delayed);
extern int dk5q_set_key_b(dk5q_handle handle, uint8_t key, uint8_t b, bool delayed);
